...
namespace eosio {
    class ledger_table {
        public:
            ...
            void add_ledger(uint64_t action_id, chain::transaction_id_type transaction_id, uint64_t block_number, std::string block_time, std::string receiver, chain::action action);
